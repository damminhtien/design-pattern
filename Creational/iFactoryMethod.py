...
class TransportCreator(ABC):
    ...
    def some_operation(self) -> str:
        ...
        # Now, use the product.
        result = f"Transporter: Your good {product.operation()}"
...
class TruckCreator(TransportCreator):
    ...
    def factory_method(self) -> Deliver:
        return Truck()
...
def client_code(creator: TransportCreator) -> None:
    """
    ...
    print(f"Client: I'm not aware of the transporter's class, but it still works.\n"
